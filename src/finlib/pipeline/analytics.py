...
def compute_market_summary(
    ohlcv_repo: OHLCVRepository, symbols: list[str], window: int = 24
) -> pd.DataFrame:
    """
...
def get_market_price(
    ohlcv_repo: OHLCVRepository, symbols: list[str], first_ts: datetime
) -> pd.DataFrame:
    """
...
def compute_portfolio_performance_metrics(
    trade_repo: TradeRepository, ohlcv_repo: OHLCVRepository
