...
def test_historic_market_value_calculation(sample_historic_portfolio: Portfolio, 
                                           sample_market_making_prices: pd.DataFrame) -> None:
...
def test_historic_pnl_calculation(sample_historic_portfolio: Portfolio, 
                                  sample_market_making_prices: pd.DataFrame) -> None:
...
def test_historic_market_value_missing_symbol(sample_historic_portfolio: Portfolio, 
                                              sample_market_making_prices: pd.DataFrame) -> None:
    sample_historic_portfolio.trades.append(Trade(symbol="ZZZ", 
                                                  quantity=Decimal(10.), 
                                                  price=Decimal(10.), 
                                                  side="BUY", 
