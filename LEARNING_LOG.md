...
- the usefulness of Pydantic and dataclasses vs simple numpy arrays
- threading as a form of concurrency
- asynchronous processing as a form of cooperational concurrency
- use of generators and generator expressions for lazy processing
- `itertools` as a very important tool
